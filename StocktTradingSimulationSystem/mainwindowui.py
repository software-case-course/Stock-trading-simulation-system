...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sharesnumber = QtWidgets.QLineEdit(self.horizontalLayoutWidget)
        self.sharesnumber.setStyleSheet("font: 10pt \"微软雅黑\";")
        self.sharesnumber.setObjectName("sharesnumber")
        self.horizontalLayout.addWidget(self.sharesnumber)
        self.verticalLayout = QtWidgets.QVBoxLayout()
        self.verticalLayout.setObjectName("verticalLayout")
        self.selectbutton = QtWidgets.QComboBox(self.horizontalLayoutWidget)
        self.selectbutton.setStyleSheet("font: 10pt \"微软雅黑\";")
        self.selectbutton.setObjectName("selectbutton")
        self.selectbutton.addItem("")
        self.selectbutton.addItem("")
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sharesnumber.setText(_translate("MainWindow", "请输入股票代码"))
        self.selectbutton.setItemText(0, _translate("MainWindow", "腾讯"))
        self.selectbutton.setItemText(1, _translate("MainWindow", "新浪"))
